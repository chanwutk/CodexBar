...
func showAbout() {
    ...
    let credits = NSMutableAttributedString(string: "CodexBar — MIT License\n")
    credits.append(makeLink("GitHub", urlString: "https://github.com/chanwutk/CodexBar"))
    credits.append(separator)
    credits.append(makeLink("Releases", urlString: "https://github.com/chanwutk/CodexBar/releases"))
